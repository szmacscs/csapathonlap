<nav class="navbar navbar-expand-lg navbar-dark bg-dark" id="header">
    <div class="container-fluid">
        <div id="header-logo">
            <a  id="scout-lily-logo" href="https://cserkesz.hu"><img src="../assets/images/logo-black-white-vector.svg" ></a>
            <a  id="team-logo" href="#"><img src="../assets/images/szmacscs-logo-sk.svg" ></a>
